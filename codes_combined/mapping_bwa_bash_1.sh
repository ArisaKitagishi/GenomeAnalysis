...
do
	...
	bwa aln $reference $unpaired_1 > "${file}_unpaired1_aln.sai"
	bwa aln $reference $unpaired_2 > "${file}_unpaired2_aln.sai"
	...
	bwa sampe $reference "${file}_unpaired1_aln.sai" "${file}_unpaired2_aln.sai" $paired_1 $paired_2 > "${file}_bwa_sampe.sam"	
